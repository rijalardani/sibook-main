  ...
  <form action="/dashboard/posts/{{$post->slug}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <div class="col-md-8">  
        ...
        @error('dokumen')
        is-invalid
        @enderror" id="dokumen" name="dokumen" autofocus value="{{ old('dokumen'), $post->dokumen }}">
        @error('dokumen')
...
<script>
  ...
  function previewDok() {
    const dokumen = document.querySelector('#image');
    const dokumenPreview = document.querySelector('.img-preview');
